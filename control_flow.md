...
جمله `for..in` یک عبارت حلقه‌ای دیگر است که بر روی یک دنباله از اشیاء تکرار می‌شود، یعنی از هر بخش در یک دنباله عبور می‌کند. در فصل‌های بعدی بیشتر در مورد [sequences(دنباله‌ها)](./data_structures.md#sequence) صحبت خواهیم کرد. چیزی که در حال حاضر باید بدانید این است که یک دنباله فقط یک مجموعه مرتب از دستورالعمل است.
